...
// $.post("BackupFileDelete.php", {file_to_copy_delete: url_to_copy_str, file_backup: url_backup_str},function(data,status){alert(data);});
//
...
// "BackupFileDelete.php":   URL parameter specifies the URL you wish to request
//                           Please note that the whole file will be executed. Not a normal function call
// file_to_copy_delete:      Input PHP parameter for the execution (url_to_copy_str is the JavaScript parameter) 
...
$file_to_copy_delete = $_POST['file_to_copy_delete'];
$file_backup = $_POST['file_backup'];

echo "BackupFileDelete.php Enter\n";

echo "file_to_copy_delete= " . $file_to_copy_delete . "\n";

echo "file_backup=  $file_backup \n";

if (!copy($file_to_copy_delete, $file_backup)) 
{
    echo "Copy of file $file_to_copy_delete failed ...\n";
}
else
{
...
if (!unlink($file_to_copy_delete))
{
    echo "Copy of file $file_to_copy_delete failed ...\n";
}
else
{
    echo "File $file_to_copy_delete is deleted\n";
}
