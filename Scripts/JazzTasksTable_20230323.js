...
*/
	...
	// Case deputies: An array of responsibles
    getJazzTasksNameArray(i_jazz_tasks_name_array_case)
    {
        ...
        if (i_jazz_tasks_name_array_case == 'reg_number' || 
			...
			i_jazz_tasks_name_array_case == 'deputies' ||
        ...
        for (var task_number=1; task_number <= n_records; task_number++)
        {
			...
			var deputy_names = current_task.getJazzTaskDeputiesString();
			...
			else if (this.m_jazz_tasks_name_array_case == 'deputies')
            {
                this.m_jazz_tasks_name_array[task_number - 1] = deputy_names; 
            }
